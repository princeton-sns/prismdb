...
class LEVELDB_EXPORT Env {
 public:
  ...
  virtual std::string TimeToString(uint64_t secondsSince1970) = 0;
};
...
class LEVELDB_EXPORT EnvWrapper : public Env {
 public:
  ...
  std::string TimeToString(uint64_t secondsSince1970) { return target_->TimeToString(secondsSince1970); }
