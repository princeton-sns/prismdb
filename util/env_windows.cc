...
class WindowsEnv : public Env {
 public:
  ...
  void Schedule(void (*background_work_function)(void* background_work_arg, void* background_work_arg2),
    void* background_work_arg, void* background_work_arg2) override;
 ...
 private:
  ...
  struct BackgroundWorkItem {
    explicit BackgroundWorkItem(void (*function)(void* arg, void* arg2), void* arg, void* arg2)
...
void WindowsEnv::Schedule(
    void (*background_work_function)(void* background_work_arg, void* background_work_arg2),
    void* background_work_arg, void* background_work_arg2) {
  background_work_mutex_.Lock();
  ...
  background_work_queue_.emplace(background_work_function, background_work_arg, background_work_arg2);
  background_work_mutex_.Unlock();
}
...
void WindowsEnv::BackgroundThreadMain() {
  while (true) {
    ...
    background_work_mutex_.Unlock();
    background_work_function(background_work_arg, background_work_arg2);
  }
}
